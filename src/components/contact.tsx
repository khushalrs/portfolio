...
export function Contact() {
  ...
  const contactInfo = {
    ...
    handle: '@Khushal.Sharma',
    socials: [
      {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/sharma-khushal',
      },
      {
        name: 'Instagram',
        url: 'https://www.instagram.com/frazergene_/',
      },
      {
        name: 'Discord',
        url: 'https://discord.com/users/frazergene',
      },
      {
        name: 'Github',
        url: 'https://github.com/khushalrs',
      },
    ],
  };
